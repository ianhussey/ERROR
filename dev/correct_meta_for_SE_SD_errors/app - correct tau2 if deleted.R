...
server <- function(input, output, session) {
  ...
  identify_extreme_studies <- function(dat, n_extremes) {
    ...
    # Get the indices of the N studies with the highest tau2_if_deleted
    ...
    extreme_data <- tibble(
      ...
      tau2_if_deleted = res_inf$inf$tau2.del[extreme_indices]  # Tau2 if deleted for the extreme studies
    )
